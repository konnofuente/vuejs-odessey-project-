        ...
        <div class="relative">
          ...
          <div class="float-left w-7 h-7 leading-3">
            ...
            type="button">
              ...
              :class="{ 'fa-pause': this.playing, 'fa-play': !this.playing }"
              class="  fa fa-pause text-gray-500 text-xl"></i>
            </button>
          </div>
          <!-- Current Position -->
...
export default {
    ...
    computed:{
      ...mapState(usePlayerStore,["duration","seek","playerProgress","current_song"])
    }
}
</script>
