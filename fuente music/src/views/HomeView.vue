<template>
  <div>
    <!-- Introduction -->
    <section
      class="mb-8 py-20 text-black text-center relative landing-bg"
    >
      <div class="absolute inset-0 w-full h-full bg-contain introduction-bg"></div>
      <div class="container mx-auto">
        <div class="text-white main-header-content">
          <h1 class="font-bold text-5xl mb-5">Fuente Music: Unleash Your Melody!</h1>
          <p class="w-full md:w-8/12 mx-auto">Where Artists and Music Lovers Connect. Upload, Listen, and Discover Your Next Favorite Song.
          </p>
        </div>
      </div>
